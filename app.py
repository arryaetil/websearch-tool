...
st.set_page_config(
    page_title="Etil · Identity Research",
    page_icon="🔍",
    layout="wide",
...
<style>
    ...
    [data-testid="stSidebar"] input { background: #1a3a5c !important; border: 1px solid #2e5a8e !important; color: white !important; border-radius: 6px !important; }
    [data-testid="stSidebar"] .stTextInput label { color: #94b8d8 !important; font-size: 0.75rem !important; letter-spacing: 0.05em; text-transform: uppercase; }
    ...
    .etil-logo { font-size: 1.6rem; font-weight: 800; color: white; letter-spacing: 0.05em; }
    .etil-tagline { font-size: 0.8rem; color: #94b8d8; margin-top: 2px; }
    .etil-status { display: flex; align-items: center; gap: 8px; }
    .status-dot { width: 8px; height: 8px; border-radius: 50%; background: #22c55e; display: inline-block; }
    .status-text { font-size: 0.78rem; color: #94b8d8; }
    ...
    .data-item .di-url { color: #3b82f6; font-size: 0.75rem; font-family: monospace; margin-top: 2px; }
...
with st.sidebar:
    st.markdown("""
    <div style='padding:0 0 1rem 0;border-bottom:1px solid #1e4a70;margin-bottom:1rem'>
        <div style='font-size:1.3rem;font-weight:800;color:white;letter-spacing:.05em'>ETIL</div>
        <div style='font-size:0.72rem;color:#64a0c8;margin-top:2px'>Identity Research Platform</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    """, unsafe_allow_html=True)
    st.markdown("<div style='font-size:0.78rem;color:#94b8d8'>🤖 Model: gpt-4o + web search</div>", unsafe_allow_html=True)
...
# ── Main header ───────────────────────────────────────────────────────────────
st.markdown("""
<div class="etil-header">
    <div>
        <div class="etil-logo">🔍 Identity Research</div>
        <div class="etil-tagline">AI-assisted compliance research · Powered by dual-pass web intelligence</div>
    </div>
    <div class="etil-status">
...
if st.session_state.get("demo"):
    full_name    = "Mark van den Berg"
    city_region  = "Rotterdam, Netherlands"
    age          = "47"
    employer     = "Steens Vastgoed BV"
    context      = "Mortgage application €680,000"
